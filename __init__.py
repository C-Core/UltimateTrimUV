...
trimSets = {
  ...
  "Edges":[
    TrimDef('A', 6.0, 1024.0, 0.0, 1024.0 - 64.0 + 3.0),
    TrimDef('B', 6.0, 1024.0, 0.0, 1024.0 - 192.0 + 3.0),
    TrimDef('C', 26.0, 1024.0, 0.0, 1024.0 - 320.0 + 13.0),
    TrimDef('D', 26.0, 1024.0, 0.0, 1024.0 - 448.0 + 13.0),
  ]
}
